...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        System.out.println("introducir caracter que queremos cambiar");
        String caracter1 = sc.nextLine();

        System.out.println("Introducir caracter que queremos introducir en el texto");
        String caracterNuevo = sc.nextLine();

        String modificarCaracter = texto.replaceAll(caracter1,caracterNuevo);
        
            
        System.out.println("EL texto Modificado seria " + modificarCaracter);
        sc.close();
    }
