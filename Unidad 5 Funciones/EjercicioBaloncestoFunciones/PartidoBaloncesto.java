...
public class PartidoBaloncesto {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        { 
            int aleatorioMaximo = (int) (Math.random()*maximo) + 1;
            
            return aleatorioMaximo;
        }
        ...
        {
            int aleatorioEntreMinyMax = (int)(Math.random()*maximo) + minimo;
            return aleatorioEntreMinyMax;
        }
        ...
        static String rebote(String equipoAtaca)
        {
            ...
            boolean reboteAtaque = false;

            if(equipoAtaca.equals("E1")
            {
                reboteAtaque = rebote(E1_REBOTE_ATA );
            }
            else 
            {
                reboteAtaque = rebote(E2_REBOTE_ATA);
            }

            if(reboteAtaque && equipoAtaca.equals("E1"))
            {
                rebotePara = "E1";
            }
            else
        ...
        {   boolean rebotePara = false;
            int reboteAtaque = (int) (Math.random()*porcentajeAtaque) + 1;
            int reboteDefensa = (int)(Math.random());

            if (reboteAtaque > reboteDefensa) 
            {
                rebotePara = true;
            }
            else
